 ...
 * Helpers.h                                                                *
 *                                                                          *
 * This file defines a number of useful classes and functions               *
 * Loading this one header file will load all the other necessary headers   *
 * such "glut.h", "Vec3.h", and "Mat4x4.h".                                 *
 *                                                                          *
 *                                                                          *
 ***************************************************************************/
